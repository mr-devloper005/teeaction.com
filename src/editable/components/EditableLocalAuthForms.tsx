...
const inputClass = 'h-14 rounded-[1rem] border border-[var(--slot4-line)] bg-white px-4 text-base font-bold text-[var(--slot4-page-text)] outline-none transition placeholder:text-[var(--slot4-soft-muted-text)] focus:border-[var(--slot4-accent-fill)]'
const buttonClass = 'inline-flex h-14 items-center justify-center rounded-[1rem] bg-[var(--slot4-accent-fill)] px-6 text-sm font-black text-white shadow-[0_16px_34px_rgba(53,133,142,0.28)] transition hover:-translate-y-0.5 disabled:opacity-60'
